 ...
 * between items of {@link LinearLayoutManager}、{@link GridLayoutManager} and
...
public class SuperDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public SuperDividerItemDecoration(Context context, int orientation) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        if (mDivider == null) {
            Log.w(TAG, "@android:attr/listDivider was not set in the theme used for this "
                    + "SuperDividerItemDecoration. Please set that attribute all call setDrawable()");
        }
        a.recycle();
